import { ChatInputCommandInteraction, SlashCommandBuilder, TextChannel,PermissionsBitField, channelLink } from "discord.js";
...
const command = {
	name: "ticketlock",
	data: new SlashCommandBuilder().setName("ticketlock").setDescription("Lock ticket channel."),
